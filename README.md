...
- *webserver_LED*. Using a simple WebServer, which supports only one simultaneous client, a LED can be switched on and off from. jQuery AJAX is used for client-server communications.
